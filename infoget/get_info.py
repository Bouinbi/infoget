...
def scrp(url) : # function to get and manage data
    ...
    print(Fore.GREEN + " [+]" + Fore.WHITE + "please wait, because this operation might take some time : ")
    print("")
    ...
    print((Fore.GREEN + "----------------------------------------------------------"))
    print( Fore.GREEN + "{}  -----  {}  -----  {}  -----  {}  ".format('IP range','Country','Name','Description')) # table colon
    print((Fore.GREEN + "-------------------------------------------------------------------------------------------------------------------------------------------------"))
    a, b, c, d = 5, 6, 7, 8
